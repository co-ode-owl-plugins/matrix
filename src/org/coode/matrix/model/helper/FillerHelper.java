...
public class FillerHelper {
    ...
    public <R extends OWLPropertyRange, P extends OWLPropertyExpression<R,P>> Set<R> getAssertedFillers(OWLClass cls, P prop, Class<? extends OWLQuantifiedRestriction<R, P, R>> type) {
        ...
        for (OWLOntology ont : mngr.getActiveOntologies()){
            for (OWLSubClassOfAxiom ax : ont.getSubClassAxiomsForSubClass(cls)){
                ...
                if (type.isAssignableFrom(superCls.getClass())){
                    OWLQuantifiedRestriction<R, P, R> restr = type.cast(superCls);
    ...
    public <R extends OWLPropertyRange, P extends OWLPropertyExpression<R,P>> Set<R> getInheritedNamedFillers(OWLClass cls, P prop, Class<? extends OWLQuantifiedRestriction<R, P, R>> type) {
        Set<R> namedFillers = new HashSet<R>();
    ...
    public <R extends OWLPropertyRange, P extends OWLPropertyExpression<R,P>> Set<R> getAssertedNamedFillersFromEquivs(OWLClass cls, P prop, Class<? extends OWLQuantifiedRestriction<R, P, R>> type) {
        Set<R> namedFillers = new HashSet<R>();
            ...
            if (equiv instanceof OWLObjectIntersectionOf){
                for (OWLClassExpression descr : ((OWLObjectIntersectionOf)equiv).getOperands()){
                    if (type.isAssignableFrom(descr.getClass())){
                        OWLQuantifiedRestriction<R, P, R> restr = type.cast(descr);
                        if (restr.getProperty().equals(prop)){
                            R filler = restr.getFiller();
                            namedFillers.add(filler);
                        }
                ...
                if (type.isAssignableFrom(equiv.getClass())){
                    OWLQuantifiedRestriction<R, P, R> restr = type.cast(equiv);
                    if (restr.getProperty().equals(prop)){
                        R filler = restr.getFiller();
                        namedFillers.add(filler);
                    }
    ...
    public <R extends OWLPropertyRange, P extends OWLPropertyExpression<R,P>> List<OWLOntologyChange> setFillers(OWLClass cls,
                                                                                                                 P p,
                                                                                                                 Set<R> fillers,
    ...
    public <R extends OWLPropertyRange, P extends OWLPropertyExpression<R,P>> List<OWLOntologyChange> addNamedFillers(OWLClass cls,
                                                                                                                 P p,
                                                                                                                      Class<? extends OWLQuantifiedRestriction<R,P, R>> type,
                                                                                                                 Set<R> fillers,
                                                                                                                 OWLOntology activeOnt) {
    ...
    private <R extends OWLPropertyRange, P extends OWLPropertyExpression<R,P>> OWLRestriction createRestriction(P p, R filler, Class<? extends OWLQuantifiedRestriction<R, P, R>> restrType) {
