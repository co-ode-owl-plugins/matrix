...
public class RestrictionTreeMatrixModel extends AbstractMatrixModel<OWLClass> {
    ...
    private static <R extends OWLPropertyRange, P extends OWLPropertyExpression> FillerModel<R, P> createFillerModel(OWLClass cls,
    ...
    private static Set<OWLPropertyRange> getFillerSet(Object value) {
    ...
    private <R extends OWLPropertyRange, P extends OWLPropertyExpression> List<OWLOntologyChange> performAdd(OWLClass cls,
                                                                                                                  P objProp,
                                                                                                                  Set<R> values,
    ...
    public static class PropertyRestrictionPair<R extends OWLPropertyRange, P extends OWLPropertyExpression> extends AbstractColumnFilterPair<P, Class<? extends OWLQuantifiedRestriction<R>>> {
        ...
        public PropertyRestrictionPair(P object, Class<? extends OWLQuantifiedRestriction<R>> filter) {
            super(object, filter);
        }
