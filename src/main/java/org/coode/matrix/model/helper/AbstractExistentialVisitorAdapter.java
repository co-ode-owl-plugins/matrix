...
public abstract class AbstractExistentialVisitorAdapter extends OWLObjectVisitorAdapter {
    ...
    public AbstractExistentialVisitorAdapter(Set<OWLOntology> onts) {
        this.onts = onts;
    }
...
//    }
    ...
    protected abstract void handleRestriction(OWLQuantifiedRestriction<OWLClassExpression> restriction);
}
